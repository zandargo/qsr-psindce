<template>
  <div>
    <q-fab
      ...
      <!--//* LOCALIZAÇÃO -->
      <q-fab-action
        @click="onClickButton('https://maps.app.goo.gl/gZ5P5Pv2Yqi8wiAy7', '_blank')"
      	color="primary"
      ...
      <!--//* EMAIL -->
      <q-fab-action
        @click="onClickButton('mailto:psindce@gmail.com', '_blank')"
      	color="primary"
      	icon="mail"
      />
      ...
      <!--//* TWITTER -->
      <q-fab-action
        @click="onClickButton('https://x.com/psindce', '_blank')"
      	color="none"
        class="q-pa-none"
      >
       <template v-slot:icon>
